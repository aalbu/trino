...
public class SemiTransactionalHiveMetastore
{
    ...
    private Map<String, HiveColumnStatistics> updateColumnStatistics(
            Map<String, HiveColumnStatistics> oldColumnStats, Map<String, HiveColumnStatistics> newColumnStats)
    {
        return ImmutableMap.<String, HiveColumnStatistics>builder()
                .putAll(newColumnStats)
                .putAll(oldColumnStats.entrySet().stream()
                        .filter(entry -> !newColumnStats.containsKey(entry.getKey()))
