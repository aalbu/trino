        ...
        extends ProductTest
{
            ...
            throws Exception
    {
        ...
        setSessionProperty(onPresto().getConnection(), "hive.collect_column_statistics_on_write", "false");
        setupTimestampData(tableName, storageFormat);
...
//                                "NANOSECONDS", "1967-01-02 12:34:56.123456789")),
    ...
    private static class TimestampAndPrecision
    {
        ...
        private final Map<String, String> readValues; // expected values to be read back at various precisions
